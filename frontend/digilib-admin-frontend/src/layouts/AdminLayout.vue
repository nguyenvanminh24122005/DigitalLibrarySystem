  ...
  <div class="app-shell" :class="{ 'sidebar-collapsed': sidebarCollapsed }">
    <aside class="sidebar">
      <RouterLink to="/dashboard" class="logo">
        ...
        <span class="logo-text">DIGILIB</span>
      </RouterLink>
      ...
      <div class="nav-scroll">
        ...
        <RouterLink to="/copies" class="nav-item">
          <v-icon icon="mdi-package-variant" />
          <span>Bản sao & Tồn kho</span>
        </RouterLink>
        ...
        <RouterLink to="/authors" class="nav-item">
          <v-icon icon="mdi-account-edit-outline" />
          <span>Tác giả</span>
        </RouterLink>

        <RouterLink to="/publishers" class="nav-item">
        ...
        <RouterLink to="/readers" class="nav-item">
      ...
      <header class="topbar">
        ...
        <div class="topbar-right">
          <div class="search-wrap" ref="searchBoxRef">
            ...
            <div
              v-if="searchFocused && filteredSearchItems.length"
              class="dropdown-panel search-panel"
            >
              <button
          ...
          <div class="dropdown-wrap" ref="profileMenuRef">
            ...
            <div v-if="profileOpen" class="dropdown-panel profile-panel">
              <button type="button" class="dropdown-item" @click="goTo('/profile')">
                <v-icon icon="mdi-account-circle-outline" />
                Hồ sơ cá nhân
              </button>

              <button type="button" class="dropdown-item" @click="goTo('/settings')">
                <v-icon icon="mdi-cog-outline" />
                Cài đặt hệ thống
              </button>

              <button type="button" class="dropdown-item" @click="goTo('/logs')">
                <v-icon icon="mdi-text-box-search-outline" />
                Nhật ký hệ thống
              </button>
...
const notifications = ref([
  {
    id: 1,
    title: 'Báo cáo',
    description: 'Có thể đồng bộ báo cáo mới từ events.',
    path: '/reports',
    read: false
  },
  {
    id: 2,
    title: 'Nhật ký',
    description: 'Kiểm tra nhật ký hệ thống gần đây.',
    path: '/logs',
    read: false
  },
  {
